...
INSTANTIATE_TEST_CASE_P(FractionTests,
        FractionTests,
        testing::Combine(
            testing::Values(0, 10, 1, 190, 140, 2, -2, 5874, -2537),
            testing::Values(0,-500, 500, 10, 330, -12, 15, -4, 4, 495, -645))
);
...
INSTANTIATE_TEST_CASE_P(ComplexTests,
        ComplexTests,
        testing::Combine(
            testing::Values(0.0, 5.0, -67.0, 97.0, -392, 19),
            testing::Values(0.0, -5.0, 67.0, -97.0, 878.0, -23),
            testing::Values(0.0, 5.0, -73.0, 17.0, 500.0, -35),
            testing::Values(0.0, -5.0, 73.0, -17.0, -500.0, 65))
);
